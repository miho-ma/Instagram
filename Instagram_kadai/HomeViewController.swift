...
//            let commentsRef = Firestore.firestore().collection(Const.CommentPath).whereField("post", isEqualTo: "wVTvKhWtMJnwTbopFUAw")//.order(by: "date", descending: true)
...
//        cell.setCommentData(commentArray[indexPath.row])
    ...
    @objc func handleCommentButton(_ sender: UIButton, forEvent event: UIEvent) {
        ...
        commentViewController.argString = postData.id
//        commentViewController.argString2 = postData
